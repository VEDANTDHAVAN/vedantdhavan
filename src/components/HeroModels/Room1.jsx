...
export function Room1(props) {
  ...
  const matcapTexture = useTexture("/images/textures/water.jpg");
  ...
  const customMaterials = useMemo(
    () => ({
      ...
      pillowMaterial: new THREE.MeshPhongMaterial({ color: "#833800" }),
      chairMaterial: new THREE.MeshPhongMaterial({ color: "#FCCF00" }),
    }),
    [matcapTexture]
  );
